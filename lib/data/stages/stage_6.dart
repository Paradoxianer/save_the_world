...
final Stage stage6 = Stage(
  ...
  activeTasks: ["Bibellesen", "Beten", "Schlafen", "Kollekte", "Einsatzwagen anschaffen", "Kinderprogramm"],
  ...
  allTasks: [
    ...
    Task(
      ...
      modifier: [AddTask(task: "Hauptamtliches Team ausbauen")],
    ),
    Task(
    ...
    Task(
      ...
      description: "MEILENSTEIN: Von der ersten Kraft zum echten Team - weitere Vollzeitkräfte für die Front (Limit 800).",
      duration: 30000.0,
      isMilestone: true,
      cost: [Money(value: 3000.0), Wisdom(value: 200.0), Member(value: 100.0)],
      award: [Member(value: 1.0)],
      modifier: [
        MessageModifier(message: "PROFIS: Aus der ersten Kraft ist ein echtes Team geworden. Limit 800!"),
