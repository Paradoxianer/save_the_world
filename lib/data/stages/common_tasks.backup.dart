...
final Task DerHeiligeGeistmchtewirken = Task(
  ...
  missed: [SubtractRes(ressources: [Faith(value: 20.0)]), MessageModifier(message: "Das Wirken Gottes wurde im Alltagsstress übersehen.")],
);
...
final Task BeerdigungeinesGenerals = Task(
  ...
  missed: [SubtractRes(ressources: [Faith(value: 100.0)]), MessageModifier(message: "Die Bewegung ist verunsichert. Der Glaube sinkt massiv.")],
);
